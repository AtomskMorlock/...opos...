...
0.2.1 - Corrección errores clickbox Configuración
0.2.0 - Actualización a TESTA+, estilos, colores, funcionalidades.
0.1.0 - Inicializacion del sistema de versionado SemVer.
